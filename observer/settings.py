...
SECRET_KEY = 'django-insecure-#rm32a3)s(z5+!88@*34z37ajiti6lvz%c%k0eg4f1h$$#pok*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '0.0.0.0', '[::1]', '.localhost', '45.61.48.18']
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'Eurochem')
...
REACT_APP_DIR = os.path.join(BASE_DIR, 'emulator')
